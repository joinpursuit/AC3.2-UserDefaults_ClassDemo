...
class InstaCatFactory {
    ...
    class func makeInstaCats(fileName: String) -> [InstaCat]? {
        ...
        guard let instaCatsURL: URL = InstaCatFactory.manager.getResourceURL(from: fileName),
            ...
            let instaCatsAll: [InstaCat] = InstaCatFactory.getInstaCats(from: instaCatData) else {
                return nil
        }
    ...
    static func getInstaCats(from jsonData: Data) -> [InstaCat]? {
  ...
  static func getCodedInstaCats(from jsonData: Data) -> [CodingInstaCat]? {
    ...
    do {
      ...
      instaCatArray.forEach({ instaCatObject in
        ...
        // append to our temp array
        instaCats.append(CodingInstaCat(name: instaCatName, catID: instaCatID, instagramURL: instaCatInstagramURL))
      })
